...
class WpGlide {
   ...
   */
  public function init( array $config = [], string $baseUrl = 'img/', string $uploadsPath = null, string $cachePath = null ) {
  ...
  public function addSize( string $slug, array $imageConfig, array $serverConfig = [] ) {
    $imageConfig['fm'] = $imageConfig['fm'] ?: 'webp';
    $imageConfig['q'] = $imageConfig['q'] ?: 90;
